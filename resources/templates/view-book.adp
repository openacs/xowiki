<!-- Generated by ::xowiki::ADP_Generator on Thu Oct 06 11:18:29 CEST 2016 -->
<master>
...
if {$book_prev_link ne ""} {
  template::add_event_listener  -id bookNavPrev.a  -prevent_preventdefault=false  -script [subst {TocTree.getPage("$book_prev_link");}]
}
if {$book_next_link ne ""} {
  template::add_event_listener  -id bookNavNext.a  -prevent_preventdefault=false  -script [subst {TocTree.getPage("$book_next_link");}]
}
